...
urlpatterns = [
    ...
    path('tour/reservation/<id>', views.reservation_view, name='reservation_view'),
    # Search Tour
...
# ------- Hotel urls -------
    ...
    path('hotel/reservation_hotel/<id>', views.reservation_hotel_view, name='reservation_hotel_view'),
